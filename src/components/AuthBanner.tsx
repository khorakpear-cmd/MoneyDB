...
import { Cloud, ShieldCheck, Database, ArrowRight } from 'lucide-react';
...
export const AuthBanner: React.FC<AuthBannerProps> = ({ user, loadingAuth, onOpenAddModal }) => {
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex flex-col gap-2.5 w-full sm:w-auto shrink-0">
          <button
            ...
            className="flex items-center justify-center gap-3 px-6 py-3.5 rounded-2xl bg-white hover:bg-slate-100 active:scale-98 text-slate-900 font-semibold text-sm shadow-lg transition cursor-pointer"
          >
