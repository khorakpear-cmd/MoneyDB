...
import { signInWithGoogle, logoutUser, FIREBASE_PROJECT_ID } from '../lib/firebase';
          ...
          <div className="flex items-center gap-3">
            ...
            {loadingAuth ? (
              ...
              <button
                ...
                type="button"
                onClick={handleLogin}
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border border-slate-300 bg-white hover:bg-slate-50 active:bg-slate-100 text-slate-700 text-xs sm:text-sm font-medium shadow-xs transition cursor-pointer"
              >
                {/* Google "G" Icon */}
